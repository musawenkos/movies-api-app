                                        ...
                                        <div class="d-flex flex-row justify-content-sm-center">
                                            @for ($i = 0; $i < 5; $i++)
                                                <div class="col-md-2 me-2 col-lg-2">
                                                    <a href="/hpw/movies/{{$category[$i]['id']}}"><img src="https://image.tmdb.org/t/p/original/{{$category[$i]['poster_path']}}" height="220" width="200" alt="..." ></a>
                                                    <div>
                                ...
                                @else
                                    <div class="carousel-item">
                                        <div class="d-flex flex-row justify-content-sm-center">
                                            @for ($j = $i; $j < ($i + 5); $j++)
                                                <div class="col-md-2 me-2 col-lg-2">
                                                    <a href="/hpw/movies/{{$category[$j]['id']}}"><img src="https://image.tmdb.org/t/p/original/{{$category[$j]['poster_path']}}" height="220" width="190" alt="..." ></a>
                                                    <div>
